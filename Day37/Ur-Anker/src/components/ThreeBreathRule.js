// UrAnker/src/components/ThreeBreathRule.js (automatischer Ablauf)
...
const ThreeBreathRule = ({ onComplete }) => {
  ...
  useEffect(() => {
    const STEP_DURATION = 8000; // z.B. 8 Sekunden pro Schritt
  ...
  const getInstruction = () => {
    switch (step) {
      ...
      case 3:
        return '3/3: Halte beim Ausatmen das Gefühl des Vertrauens fest.';
      default:
    ...
    <View style={styles.fullScreen}>
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={onComplete}   // Abbrechen & zurück
        >
          <Text style={styles.buttonText}>
            {isComplete ? 'Geschafft' : 'Abbrechen & zurück'}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
