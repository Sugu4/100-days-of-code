...
Dieses Repository dokumentiert meine persönliche **100-Tage-Coding-Challenge** – mit **HTML, CSS, JavaScript, Python, API (Backend/Frontend-Anbindung)** und **GitHub Pages**.  
